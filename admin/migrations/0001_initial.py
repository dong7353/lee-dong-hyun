# Generated by Django 3.1.1 on 2020-11-14 04:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_id', models.CharField(blank=True, max_length=40, null=True)),
                ('c_pw', models.CharField(blank=True, max_length=100, null=True)),
                ('c_phone', models.CharField(blank=True, max_length=20, null=True)),
                ('c_gender', models.CharField(blank=True, choices=[('남', '남'), ('여', '여')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('l_subject', models.CharField(choices=[('수학', '수학'), ('영어', '영어')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='notice_tbl',
