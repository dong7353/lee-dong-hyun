...
class customer_tbl(models.Model):
    ...
    # c_gender = models.CharField(max_length=10, choices=(('남','남'),('여','여')))
    ...
    c_id = models.CharField(max_length=40, null=True, blank=True)
    c_pw = models.CharField(max_length=100, null=True, blank=True)
...
class teacher_tbl(models.Model):
    ...
    t_gender = models.CharField(max_length=10,choices=(('남','남'),('여','여')))
